...
# - grid file
gridfile = '/store/CT1/hmg2840/lbrodeau/eNATL60/eNATL60-I/eNATL60_coordinates_v3.nc4'
...
Box_01 = ['32.0','30.0','-70.0','-68.0','Box_1']
Box_02 = ['32.0','30.0','-68.0','-66.0','Box_2']
Box_03 = ['32.0','30.0','-66.0','-64.0','Box_3']
Box_04 = ['32.0','30.0','-64.0','-62.0','Box_4']
Box_05 = ['32.0','30.0','-62.0','-60.0','Box_5']
Box_06 = ['32.0','30.0','-60.0','-58.0','Box_6']
Box_07 = ['32.0','30.0','-58.0','-56.0','Box_7']
Box_08 = ['32.0','30.0','-56.0','-54.0','Box_8']
Box_09 = ['32.0','30.0','-54.0','-52.0','Box_9']
Box_10 = ['32.0','30.0','-52.0','-50.0','Box_10']
Box_11 = ['32.0','30.0','-50.0','-48.0','Box_11']
Box_12 = ['32.0','30.0','-48.0','-46.0','Box_12']
Box_13 = ['32.0','30.0','-46.0','-44.0','Box_13']
Box_14 = ['32.0','30.0','-44.0','-42.0','Box_14']
